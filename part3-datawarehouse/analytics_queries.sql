...
-- Business Scenario: "The product manager needs to identify top-performing products. Show the top 10 products by 
-- revenue, along with their category, total units sold, and revenue contribution percentage."
